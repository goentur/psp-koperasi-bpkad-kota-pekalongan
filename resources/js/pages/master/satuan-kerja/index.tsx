...
export default function Index({ gate }: IndexGate) {
    ...
    const getData = async () => {
        setLoading(true)
        try {
            const response = await axios.post(route('satuan-kerja.data'), {
    ...
    const handleForm = (e: React.FormEvent) => {
        ...
        const routeName = isEdit ? route('satuan-kerja.update', data).toString() : route('satuan-kerja.store').toString()
    ...
    const handleHapus = (e: React.FormEvent) => {
        e.preventDefault()
        destroy(route('satuan-kerja.destroy', data), {
            preserveScroll: true,
                ...
                <Card>
                    ...
                    <CardContent>
                        <DataTableFilters
                            ...
                            onClick={() => {setIsEdit(false), setForm(true)}}
                        />
                        <DataTable
                            gate={gate}
                            loading={loading}
