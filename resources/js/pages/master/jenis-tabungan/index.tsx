...
export default function Index({ gate }: IndexGate) {
    ...
    const getData = async () => {
        setLoading(true)
        try {
            const response = await axios.post(route('jenis-tabungan.data'), {
    ...
    const handleForm = (e: React.FormEvent) => {
        ...
        const routeName = isEdit ? route('jenis-tabungan.update', data).toString() : route('jenis-tabungan.store').toString()
    ...
    const handleHapus = (e: React.FormEvent) => {
        e.preventDefault()
        destroy(route('jenis-tabungan.destroy', data), {
            preserveScroll: true,
