...
export default function Index() {
    ...
    useEffect(() => {
        getData()
    }, [infoDataTabel.page, infoDataTabel.search, infoDataTabel.perPage, filter.type, filter.anggota])

    const getData = async () => {
        setLoading(true)
        try {
            const response = await axios.post(route('transaksi.dataTransaksi'), {
